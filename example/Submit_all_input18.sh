...
RUNPY=/cms_scratch/jhchoi/keras_my/scripts_ntree30000_shrinkage_0p1/TMVA_jhchoi/example/test_input18.py
...
for F in ${ARR_F[@]};do
    #echo $F
    python python_tool/ExportShellCondorSetup.py -c "python ${RUNPY} ${INPUTDIR}/${F}" -d "WORKDIR_2018/${F}" -n "testinput" -m 1 -s 
