...
INPUTDIR="${address}"'//xrd/store/user/jhchoi/Latino/HWWNano/Fall2017_102X_nAODv7_Full2017v7_HWW/MCl1loose2017v7__MCCorr2017v7__HMSemilepSKIMv7_1__HMFull_V13_jhchoi_nom/'


RUNPY=/cms_scratch/jhchoi/keras_my/scripts_ntree30000_shrinkage_0p1/TMVA_jhchoi/example/test_input17.py
...
ARR_F=()
cd /xrootd//store/user/jhchoi/Latino/HWWNano/Fall2017_102X_nAODv7_Full2017v7_HWW/MCl1loose2017v7__MCCorr2017v7__HMSemilepSKIMv7_1__HMFull_V13_jhchoi_nom/
...
for F in ${ARR_F[@]};do
    #echo $F
    python python_tool/ExportShellCondorSetup.py -c "python ${RUNPY} ${INPUTDIR}/${F}" -d "WORKDIR_2017/${F}" -n "testinput" -m 1 -s 
