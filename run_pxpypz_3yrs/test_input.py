...
##WW resonance
myreader.AddVariable("lnJ_DeepAK8WP0p5_nom_pt",lnJ_pt)
myreader.AddVariable("TMath::ASinH((WtaggerFatjet_DeepAK8WP0p5_nom_pt[lnJ_DeepAK8WP0p5_nom_widx]*TMath::SinH(WtaggerFatjet_DeepAK8WP0p5_nom_eta[lnJ_DeepAK8WP0p5_nom_widx])+Wlep_nom_pt*TMath::SinH(Wlep_nom_eta))/lnJ_DeepAK8WP0p5_nom_pt)",lnJ_eta)
myreader.AddVariable("TMath::ATan2((WtaggerFatjet_DeepAK8WP0p5_nom_pt[lnJ_DeepAK8WP0p5_nom_widx]*TMath::Sin(WtaggerFatjet_DeepAK8WP0p5_nom_phi[lnJ_DeepAK8WP0p5_nom_widx])+Wlep_nom_pt*TMath::Sin(Wlep_nom_phi)),(WtaggerFatjet_DeepAK8WP0p5_nom_pt[lnJ_DeepAK8WP0p5_nom_widx]*TMath::Cos(WtaggerFatjet_DeepAK8WP0p5_nom_phi[lnJ_DeepAK8WP0p5_nom_widx])+Wlep_nom_pt*TMath::Cos(Wlep_nom_phi)))",lnJ_phi)
