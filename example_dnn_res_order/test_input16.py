...
myreader.AddVariable('Alt$(AddJetResol_'+ALGO+'_nom_eta[0] , 3.)',AddJet_pt2)
myreader.AddVariable('Alt$(AddJetResol_'+ALGO+'_nom_pt[1], 3.)',AddJet_eta2)
myreader.AddVariable('Alt$(AddJetResol_'+ALGO+'_nom_eta[1] , 3.)',AddJet_eta1)
